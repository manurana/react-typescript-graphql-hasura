...
const TodoPublicList = (props: publicListProps) => {
  ...
  // TODO: see how this typeing was done
  const [todos, setTodos] = useState<GetOldPublicTodosQuery["todos"]>([]);

  // TODO: understand this better
  let oldestTodoId = useRef(
    props.latestTodo && props.latestTodo.id ? props.latestTodo.id + 1 : 0
  );
  let newestTodoId = useRef(
    props.latestTodo && props.latestTodo.id ? props.latestTodo.id : 0
  );
